...
|---|---|---|---|
| [qwen3.6-35b-a3b-nvfp4-nvidia.yaml](qwen3.6-35b-a3b-nvfp4-nvidia.yaml) | `vllm-node` | `gx10 qwen3.6-35b-a3b` | `mods/fix-qwen3.5-autoround`, `mods/fix-qwen3-coder-next`, `mods/fix-qwen3.6-chat-template` |
